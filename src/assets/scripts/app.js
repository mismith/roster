angular.module('roster-io', [
	...
	.config(function ($opbeatProvider, $locationProvider, $urlRouterProvider, $urlMatcherFactoryProvider, $stateProvider, $firebaseHelperProvider, $sceProvider, $compileProvider) {
