...
angular.module('roster-io', ['ui.router', 'ngMaterial', 'firebaseHelper', 'ngTouch'])
	...
	.controller('RostersCtrl', function ($scope, $firebaseHelper, Auth, $mdDialogForm, $mdToast) {
		Auth.$onAuth(function (authData) {
			if (authData) {
...
*/
	...
	.controller('RosterCtrl', function ($scope, $firebaseHelper, $mdDialogForm, $state, $mdToast, $q, Api, RSVP) {
...
*/
	...
	.controller('EventCtrl', function ($scope, $firebaseHelper, $mdDialogForm, $state, $mdToast, Auth, RSVP, $location) {
		$scope.roster = $firebaseHelper.object('data/rosters', $state.params.roster);
	...
	.controller('InviteCtrl', function ($scope, $firebaseHelper, $state, $q, Auth, $mdToast, $mdDialog) {
