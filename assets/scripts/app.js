angular.module('roster-io', ['ui.router', 'ngMaterial', 'firebaseHelper'])
	...
	.controller('RostersCtrl', function ($scope, $firebaseHelper) {
		$scope.threads = [];
